...
//    static String[] getStudentDetails(Student student) {
//        String[] details = new String[4];
//        details[0] = Integer.toString(student.getStudentId());
//        details[1] = student.getName();
//        details[2] = Integer.toString(student.getAge());
//        details[3] = Integer.toString(student.getClassId());
//        return details;
//    }
//
//
//    static String[] getClassDetails(Classroom classroom) {
//        String[] details = new String[4];
//        details[0] = Integer.toString(classroom.getClassId());
//        details[1] = classroom.getName();
//        details[2] = Integer.toString(classroom.getGrade());
//        details[3] = classroom.getTeacherName();
//        return details;
//    }
//
//    static String[] getCombinedDetails(Student student, Classroom classroom) {
//        String[] studentDetails = getStudentDetails(student);
//        String[] classDetails = getClassDetails(classroom);
//        String[] combinedDetails = new String[studentDetails.length + classDetails.length];
//        System.arraycopy(studentDetails, 0, combinedDetails, 0, studentDetails.length);
//        System.arraycopy(classDetails, 0, combinedDetails, studentDetails.length, classDetails.length);
